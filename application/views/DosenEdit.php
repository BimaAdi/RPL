...
<!-- ####################################################################################################### -->
    <div id="column">
      <ul id="latestnews">
        <li><img src="<?php echo base_url()?>/css/images/demo/WA.png" width="50" heigth="60" alt="" />
          <p><strong><a href="#">[Judul]</a></strong> ini adalah kotak chat WhatsApp (bisa juga notifikasi atau berita)</p>
        </li>
        <li><img src="<?php echo base_url()?>/css/images/demo/WA.png" width="50" heigth="60" alt="" />
          <p><strong><a href="#">[judul]</a></strong> ini adalah kotak chat Whatsapp (bisa juga notifikasi atau berita)</p>
        </li>
